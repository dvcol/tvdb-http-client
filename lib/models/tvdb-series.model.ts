...
import type { EntityTypes, Extended, Short, TvdbAlias, TvdbRemoteId, TvdbStatus, TvdbTagOption } from '~/models/tvdb-entity.model';
import type { TvdbEpisode } from '~/models/tvdb-episode.model';
import type { TvdbGenre } from '~/models/tvdb-genre.model';
import type { TvdbList } from '~/models/tvdb-list.model';
import type { TvdbRating } from '~/models/tvdb-rating.model';
import type { TvdbSeason, TvdbSeasonType } from '~/models/tvdb-season.model';
