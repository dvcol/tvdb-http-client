import type { ITvdbApi, TvdbClientAuthentication, TvdbClientOptions } from '~/models/tvdb-client.model';

import { minimalTvdbApi } from '~/api/tvdb-minimal-api.endpoints';
import { BaseTvdbClient } from '~/clients/base-tvdb-client';
...
export class TvdbClient extends BaseTvdbClient {
   ...
   */
  constructor(settings: TvdbClientOptions, authentication: TvdbClientAuthentication = {}, api: ITvdbApi = minimalTvdbApi) {
