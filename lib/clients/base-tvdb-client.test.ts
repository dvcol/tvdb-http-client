...
describe('base-tvdb-client.ts', () => {
  ...
  const response = new Response(JSON.stringify(data)) as TvdbApiResponse<typeof data>;
  ...
  describe('_parseResponse', () => {
    ...
    it('should parse a response with pagination', async () => {
      ...
      const paginatedResponse = new Response(JSON.stringify(paginatedData)) as TvdbApiResponse<typeof paginatedData>;
    ...
    it('should throw on failure response', async () => {
      ...
      const failedResponse = new Response(JSON.stringify(failedData)) as TvdbApiResponse<typeof failedData>;
    ...
    it('should throw on failed fetch response', async () => {
      ...
      }) as TvdbApiResponse<typeof data>;
