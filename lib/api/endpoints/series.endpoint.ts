...
import type { TvdbSeries, TvdbSeriesExtended, TvdbSeriesQuery, TvdbSeriesShort } from '~/models/tvdb-series.model';

import type { TvdbTranslation } from '~/models/tvdb-translation.model';

import { TvdbClientEndpoint, type TvdbPaginatedData, type TvdbParamPagination } from '~/models/tvdb-client.model';
